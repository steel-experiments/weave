...
| 12. Initiative Spec And Plan Contracts | Planned | `12-initiative-spec-and-plan-contracts.md` | Stable PRD/SOW input and initiative-plan contracts define what automation stores, proposes, approves, and executes. |
